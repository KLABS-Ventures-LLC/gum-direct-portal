        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <ScrollReveal direction="left">
            <div className="relative">
              <div className="relative rounded-3xl gradient-primary p-10 lg:p-12 shadow-elevated overflow-hidden">
                {/* Decorative */}
              ...
              {/* Floating element */}
              <div className="absolute -bottom-6 -right-6 w-32 h-32 rounded-2xl bg-accent shadow-glow -z-10" />
            </div>
          </ScrollReveal>
          ...
          <div>
            <ScrollReveal direction="right">
              ...
              <h2 className="text-display-md font-display font-bold text-foreground mb-12">
                ...
                <span className="text-gradient-dark">premium gum arabic</span>
              </h2>
            </ScrollReveal>
